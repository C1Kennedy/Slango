...
if __name__ == "__main__":
    ...
    question_set = []
    question_set.append(["He was extremely ___ that he had lost.", ["beat", "salty", "chill"], "salty"])
    question_set.append(["After the announcement, she was on the ___.", ["cap", "drugs", "copium"], "copium"])
    question_set.append(["___, she said.", ["bet", "cool", "let's go"], "bet"])
